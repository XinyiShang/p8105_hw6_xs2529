...
```
I hypothesized that mother's size, including weight and height, are important in determining baby's weight. So, I considered mom's height `mheight`, mom's pre-pregnancy weight `ppwt`, mom's pre pregnancy bmi `ppbmi`, mother’s weight at delivery (pounds) `delwt`, and mother’s weight gain during pregnancy (pounds) `wtgain` into the model.
